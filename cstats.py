...
def randomquote():
    splashes = [
        ...
        "\"true and real\" - Orknarok_666, Noggisoggi, CruxyMC, among others",
        "\"wb\" - Many players",
        "\"fer fer\" - Many people; mainly Pittofer, Krissofer & SvGaming",
        "\"hmmmm\" - Noggisoggi & many people",
        "\"https://wiki.retromc.org/\" - Noggisoggi & RetroMC staff",
        "\"Now with less Notchcode(TM)\" - Noggisoggi",
        "\"holy\" - Orknarok_666, CruxyMC, Noggisoggi and several others",
        "\"h\" - Ade1ie",
        "\"how dee feller\" - Many people, adapted from Orknarok_666",
        "\".;,;.\" - Grassboii",
        "\"/vote day\" - Many players",
        "\"Brown bricks in Minecrap\" - Many people, adapted from an Inspector Gadget parody made by Mike Matei",
